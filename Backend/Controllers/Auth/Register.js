...
const sendEmail = require('../../mailto/sendMail')
...
exports.Register = async(req,res,next) => {
    ...
    try{
        ...
        <p> Thanks for registration. Kindly follow below steps to activate your account </p>
        ...
        try{
            ...
            return res.status(200).json({success:true,message : "Email Sent to activate your account. Make sure to check your spam."})
        }catch(error){
        ...
        function(err, decoded) {
            if (err) {
                return res.status(401).json({
                    success : false,
                    error: 'Link has been expired. Signup again'
                })
            }else{
                return decoded
            }
